...
String currentDate;                   // USed to get the current date in mm/dd/yyyy format (we're weird in the US)
                                                                                            ...
                                                                                            const unsigned long pauseTime = 3000;  // CRITICAL - This determines how long in milliseconds to wait between reading attempts. Make this wait time as long as you can and still maintain functionality (more pauseTime = more power saved)
